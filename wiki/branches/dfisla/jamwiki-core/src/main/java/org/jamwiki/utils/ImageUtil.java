...
public class ImageUtil {
	...
	private static ImageDimensions resizeImage(WikiImage wikiImage, int maxDimension) throws IOException {
		...
		try {
			...
			logger.fatal("Unable to resize image.  This problem sometimes occurs due to dependencies between Java and X on UNIX systems.  Consider enabling an X server or setting the java.awt.headless parameter to true for your JVM.", t);
			resized = original;
		}
