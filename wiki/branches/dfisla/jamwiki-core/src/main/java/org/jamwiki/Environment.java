...
public class Environment {
	...
	//public static final String PROP_CACHE_TOTAL_SIZE = "cache-total-size";
        //public static final String PROP_CACHE_DISK_PERSISTENT = "cache-disk-persistent";
        //public static final String PROP_CACHE_ETERNAL = "cache-eternal";
	...
	public static final String PROP_DB_USERNAME = "db-user";
        public static final String PROP_DB_COMPRESSION = "db-compression";
	...
	*/
	...
	private static void initDefaultProperties() {
		...
		//defaults.setProperty(PROP_CACHE_TOTAL_SIZE, "1000");
                //defaults.setProperty(PROP_CACHE_DISK_PERSISTENT, Boolean.FALSE.toString());
                //defaults.setProperty(PROP_CACHE_ETERNAL, Boolean.FALSE.toString());
		...
		defaults.setProperty(PROP_DB_USERNAME, "");
                defaults.setProperty(PROP_DB_COMPRESSION, Boolean.TRUE.toString());
