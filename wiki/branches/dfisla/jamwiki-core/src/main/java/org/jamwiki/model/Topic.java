...
public class Topic implements Serializable {
    ...
    protected Integer currentVersionId = null;
    protected Timestamp deleteDate = null;
    protected String name = null;
    protected boolean readOnly = false;
    protected String redirectTo = null;
    protected String topicContent = null;
    protected String topicContentClean = null;
    protected String topicContentShort = null;
    ...
    public String getTopicContentClean() {
        return topicContentClean;
    }

    public void setTopicContentClean(String topicContentClean) {
        this.topicContentClean = topicContentClean;
    }

    public String getTopicContentShort() {
        return topicContentShort;
    }

    public void setTopicContentShort(String topicContentShort) {
        this.topicContentShort = topicContentShort;
    }
