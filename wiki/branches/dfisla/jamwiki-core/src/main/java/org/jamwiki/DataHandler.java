...
import java.sql.Connection; // JAMWIKI-NEW
import java.sql.SQLException; // JAMWIKI-NEW
import java.util.LinkedHashMap;
import java.util.List;
import java.util.Locale;
import org.jamwiki.model.Category;
import org.jamwiki.model.LogItem; // JAMWIKI-NEW
...
public interface DataHandler {
     ...
     * @param virtualWiki The virtual wiki for which topics are being
     *  retrieved.
     * @return A List of all topic ids for all non-deleted topics that
     *  exist for the virtual wiki.
     * @throws DataAccessException Thrown if any error occurs during method execution.
     */
    List<Integer> getAllTopicIdentifiers(String virtualWiki) throws DataAccessException;
     ...
     * @throws DataAccessException Thrown if any error occurs during method execution.
     */
    List<LogItem> getLogItems(String virtualWiki, int logType, Pagination pagination, boolean descending) throws DataAccessException;
     ...
     * @throws DataAccessException Thrown if any error occurs during method execution.
     */
    Topic lookupTopicMetaDataById(String virtualWiki, int topicId) throws DataAccessException;
     ...
     * @throws WikiException
     */
    void buildTopicCategories(TopicVersion topicVersion, LinkedHashMap<String, String> categories, String topicName, int topicId, String virtualWiki) throws DataAccessException, WikiException;
     ...
     *  should be created for the topic add/update, <code>true</code>
     *  otherwise.
     * @param updateSearchIndex Set to <code>true</code> if search index update
     *  should occur for the topic add/update, <code>false</code>
     *  otherwise.
     * @throws DataAccessException Thrown if any error occurs during method execution.
     * @throws WikiException Thrown if the topic information is invalid.
     */
    void writeTopic(Topic topic, TopicVersion topicVersion, LinkedHashMap<String, String> categories, List<String> links, boolean userVisible, boolean updateSearchIndex) throws DataAccessException, WikiException;
