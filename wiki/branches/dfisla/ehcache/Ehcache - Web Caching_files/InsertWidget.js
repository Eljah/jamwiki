    ...
    WIDGETBOX = {
        ...
        load : function(libPath, onLoadListener, useCdn) {
            ...
            if (!WIDGETBOX.libs[libInfo.id]) {
                ...
                if (!useCdn) {
                    script.src = "http://widgetserver.com/syndication/" + libInfo.path + ".js?33124";
                } else {
                    script.src = "http://cdn.widgetserver.com/syndication/" + libInfo.path + ".js?33124";
                }
                var head = document.documentElement.firstChild;
                if (!head) head = document.getElementsByName("head")[0];
...
//
    WIDGETBOX.renderWidget = function(appId, mode) {
