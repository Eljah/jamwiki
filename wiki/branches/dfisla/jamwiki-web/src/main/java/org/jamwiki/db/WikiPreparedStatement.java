...
public class WikiPreparedStatement {
	...
	private static final Logger logger = Logger.getLogger(WikiPreparedStatement.class.getName());
	...
	public WikiResultSet executeQuery(Connection conn) throws SQLException {
		...
		try {
			long start = System.currentTimeMillis();
                        ...
                        logger.debug("SQL-QUERY =>: " + this.sql);
			...
			logger.fatal("Failure while executing " + this.sql, e);
			throw e;
		} finally {
	...
	public int executeUpdate(Connection conn) throws SQLException {
		try {
            ...
            logger.debug("SQL-UPDATE-QUERY =>: " + this.sql);
