...
public interface QueryHandler {
	...
	WikiResultSet getAllTopicNames(int virtualWikiId) throws SQLException;
        ...
        WikiResultSet getAllTopicIdentifiers(int virtualWikiId) throws SQLException;
	 ...
	 * @throws SQLException Thrown if any error occurs during method execution.
	 */
	int insertTopicAdvanced(Topic topic, int virtualWikiId, Connection conn) throws SQLException;
	 ...
	 * @throws SQLException Thrown if any error occurs during method execution.
	 */
	int insertTopicVersionAdvanced(TopicVersion topicVersion, Connection conn) throws SQLException;
	...
	WikiResultSet lookupTopic(int virtualWikiId, String topicName, boolean caseSensitive, Connection conn) throws SQLException;
        ...
        // PERFORMANCE-EXPERIMENTAL
        WikiResultSet lookupTopicById(int virtualWikiId, int topicId, Connection conn) throws SQLException;

        // PERFORMANCE-EXPERIMENTAL
        WikiResultSet lookupTopicMetaDataById(int virtualWikiId, int topicId, Connection conn) throws SQLException;
