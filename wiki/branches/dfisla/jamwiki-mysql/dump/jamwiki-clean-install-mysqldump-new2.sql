...
--
-- Definition of table `jam_authorities`
--
...
INSERT INTO `jam_authorities` (`username`,`authority`) VALUES 
 ('admin','ROLE_ADMIN'),
 ('admin','ROLE_SYSADMIN'),
 ('admin','ROLE_TRANSLATE');
/*!40000 ALTER TABLE `jam_authorities` ENABLE KEYS */;


--
-- Definition of table `jam_category`
--
...
--
-- Definition of table `jam_file_version`
--
...
INSERT INTO `jam_group` (`group_id`,`group_name`,`group_description`) VALUES 
...
--
-- Definition of table `jam_group_authorities`
--
...
INSERT INTO `jam_group_authorities` (`group_id`,`authority`) VALUES 
 (1,'ROLE_EDIT_EXISTING'),
 (1,'ROLE_EDIT_NEW'),
 (1,'ROLE_UPLOAD'),
 (1,'ROLE_VIEW'),
 (2,'ROLE_EDIT_EXISTING'),
 (2,'ROLE_EDIT_NEW'),
 (2,'ROLE_MOVE'),
 (2,'ROLE_UPLOAD'),
 (2,'ROLE_VIEW');
...
--
-- Definition of table `jam_group_members`
--
...
INSERT INTO `jam_group_members` (`id`,`username`,`group_id`) VALUES 
 (1,'admin',2);
/*!40000 ALTER TABLE `jam_group_members` ENABLE KEYS */;


--
-- Definition of table `jam_recent_change`
--
...
INSERT INTO `jam_recent_change` (`topic_version_id`,`previous_topic_version_id`,`topic_id`,`topic_name`,`edit_date`,`edit_comment`,`wiki_user_id`,`display_name`,`edit_type`,`virtual_wiki_id`,`virtual_wiki_name`,`characters_changed`) VALUES 
 (1,NULL,1,'StartingPoints','2009-06-16 15:13:06','Automatically created by system setup',1,'admin',1,1,'en',1439),
 (2,NULL,2,'LeftMenu','2009-06-16 15:13:06','Automatically created by system setup',1,'admin',1,1,'en',354),
 (3,NULL,3,'BottomArea','2009-06-16 15:13:06','Automatically created by system setup',1,'admin',1,1,'en',73),
 (4,NULL,4,'StyleSheet','2009-06-16 15:13:06','Automatically created by system setup',1,'admin',1,1,'en',7900),
 (5,NULL,5,'HelloWorld','2009-06-16 15:13:53','',NULL,'127.0.0.1',1,1,'en',12),
 (6,5,5,'HelloWorld','2009-06-16 15:19:14','',1,'admin',1,1,'en',20),
 (7,6,5,'HelloWorld','2009-06-16 15:20:09','',NULL,'127.0.0.1',1,1,'en',18);
/*!40000 ALTER TABLE `jam_recent_change` ENABLE KEYS */;


--
-- Definition of table `jam_role`
--
...
INSERT INTO `jam_role` (`role_name`,`role_description`) VALUES 
 ('ROLE_ADMIN','Provides the ability to perform wiki maintenance tasks not available to normal users.'),
 ('ROLE_EDIT_EXISTING','Allows a user to edit an existing topic.'),
 ('ROLE_EDIT_NEW','Allows a user to create a new topic.'),
 ('ROLE_MOVE','Allows a user to move a topic to a different name.'),
 ('ROLE_SYSADMIN','Allows access to set database parameters, modify parser settings, and set other wiki system settings.'),
 ('ROLE_TRANSLATE','Allows access to the translation tool used for modifying the values of message keys used to display text on the wiki.'),
 ('ROLE_UPLOAD','Allows a user to upload a file to the wiki.'),
 ('ROLE_VIEW','Allows a user to view topics on the wiki.');
/*!40000 ALTER TABLE `jam_role` ENABLE KEYS */;


--
-- Definition of table `jam_topic`
--
...
CREATE TABLE `jam_topic` (
  ...
  CONSTRAINT `jam_f_topic_topicv` FOREIGN KEY (`current_version_id`) REFERENCES `jam_topic_version` (`topic_version_id`),
...
INSERT INTO `jam_topic` (`topic_id`,`virtual_wiki_id`,`topic_name`,`delete_date`,`topic_read_only`,`topic_admin_only`,`current_version_id`,`topic_type`,`redirect_to`) VALUES 
 (1,1,'StartingPoints',NULL,0,0,1,1,NULL),
 (2,1,'LeftMenu',NULL,0,1,2,1,NULL),
 (3,1,'BottomArea',NULL,0,1,3,1,NULL),
 (4,1,'StyleSheet',NULL,0,1,4,1,NULL),
 (5,1,'HelloWorld',NULL,0,0,7,1,NULL);
/*!40000 ALTER TABLE `jam_topic` ENABLE KEYS */;


--
-- Definition of table `jam_topic_version`
--
...
INSERT INTO `jam_users` (`username`,`password`,`enabled`) VALUES 
 ('admin','YDZcavIlBA+nceQVy6h1MJwtLoD6xQ64BHHaVH4SP9G83L0x1rr3WSFIExD42ObflQs/7MqdfSpdf/IPIm4LTjdEvUzqWnQo',1);
/*!40000 ALTER TABLE `jam_users` ENABLE KEYS */;


--
-- Definition of table `jam_virtual_wiki`
--
...
INSERT INTO `jam_virtual_wiki` (`virtual_wiki_id`,`virtual_wiki_name`,`default_topic_name`,`create_date`) VALUES 
 (1,'en','StartingPoints','2009-06-16 15:13:05');
/*!40000 ALTER TABLE `jam_virtual_wiki` ENABLE KEYS */;


--
-- Definition of table `jam_watchlist`
--
...
--
-- Definition of table `jam_wiki_user`
--
...
INSERT INTO `jam_wiki_user` (`wiki_user_id`,`login`,`display_name`,`create_date`,`last_login_date`,`create_ip_address`,`last_login_ip_address`,`default_locale`,`email`,`editor`,`signature`) VALUES 
 (1,'admin',NULL,'2009-06-16 15:13:02','2009-06-16 15:13:02','127.0.0.1','127.0.0.1',NULL,NULL,'toolbar',NULL);
