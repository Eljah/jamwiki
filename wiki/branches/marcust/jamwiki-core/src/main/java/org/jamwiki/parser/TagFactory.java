...
public interface TagFactory {
	...
	WikiReferencesTag newWikiReferencesTag();

	TemplateTag newTemplateTag();

	WikiLinkTag newWikiLinkTag();

	NoIncludeTag newNoIncludeTag();

	IncludeOnlyTag newIncludeOnlyTag();

	WikiSignatureTag newWikiSignatureTag();

	WikiHeadingTag newWikiHeadingTag();

	HtmlLinkTag newHtmlLinkTag();

	WikiReferenceTag newWikiReferenceTag();
