...
public class EmailServlet extends JAMWikiServlet {
        ...
        protected ModelAndView handleJAMWikiRequest(HttpServletRequest request,
                ...
                if (request.getParameter("newPasswordEntered") != null) { //from login-reset.jsp
                ...
                if (WikiEmailService.ACTION_CONFIRM_REGISTRATION.equals(action)){
                        ...
                        //TODO show enter confirmation code;
                }
                return next;
        }
        ...
        private void resetPassword (HttpServletRequest request,
                ...
                if (savedCode != null && savedCode.equals(code) && user.getEnabled() == 2) {
                        ...
                        pageInfo.setPageTitle(new WikiMessage("email.reset.title")); //TODO i18n
                        pageInfo.setContentJsp(JSP_NEW_PASSWORD);
                }
                else {
                        throw new WikiException(new WikiMessage("email.validation.invalid")); //TODO i18n
                }
        }
        ...
        private void newPassword (HttpServletRequest request,
                ...
                if (newPassword == null || confirmPassword == null || ! newPassword.equals(confirmPassword)) {
                        ...
                        if (savedCode != null && savedCode.equals(code) && user.getEnabled() == 2) {
                                ...
                                //WikiBase.getUserHandler().updateWikiUserInfo(userInfo, null);
